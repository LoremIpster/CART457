...
namespace Malee.Editor
{
	public class ReorderableList
	{
		...
		private void DrawFooter(Rect rect) {
			...
			Rect RemoveSelectedRect = new Rect(rect.xMax - 52f, rect.y - 1f, 25f, 13f);
		...
		static class Style {
			...
			static Style() {
				iconToolbarAdd = EditorGUIUtility.IconContent("add");
				//iconToolbarAdd = EditorGUIUtility.IconContent("d_winbtn_mac_max", "Add to list");
				iconToolbarAddMore = EditorGUIUtility.IconContent("add");
				iconToolbarRemoveSelected = EditorGUIUtility.IconContent("removeselected");
				//iconToolbarRemoveSelected = EditorGUIUtility.IconContent("d_winbtn_mac_min", "Remove selection from list");
				iconToolbarRemoveAll = EditorGUIUtility.IconContent("removeall");
